...
module.exports = function(app,passport) {
    ...
    app.get('/passport/login', function(req, res) {

        res.render('login.ejs',{ message: req.flash('loginMessage') });

    });

    app.get('/passport/signup', function(req, res){
        res.render('signup.ejs',{message: req.flash('message')});
      });

    app.post('/passport/signup', passport.authenticate('local-signup', {
            successRedirect: '/login',
            failureRedirect: '/signup',
            failureFlash : true 
    }));

    app.post('/passport/login', passport.authenticate('local-login', {
            successRedirect : '/', 
